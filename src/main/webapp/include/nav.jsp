	...
	<div class="collapse navbar-collapse" id="bs-navbar-collapse">
		...
		<c:choose>
			<c:when test="${sessionScope.login==null}">
				<button type="button" class="btn btn-success navbar-btn navbar-right" data-toggle="modal" data-target="#loginModal">
					<span class="fa fa-sign-in"></span> Connexion
				</button>
			</c:when>
			<c:otherwise>
				<a class="btn btn-defaut navbar-btn navbar-right" href="logout">
					<span class="fa fa-sign-out"></span> Déconnexion
				</a>
			</c:otherwise>
		</c:choose>
		<button type="button" class="btn btn-warning navbar-btn navbar-right" data-toggle="modal" data-target="#cartModal">

...
<script src="/LastMinuteTraining/js/jasny-bootstrap.min.js"></script>
<script src="/LastMinuteTraining/js/holder.js"></script>
<script src="/LastMinuteTraining/js/jquery.raty.js"></script>

		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form role="form">
					...
					<div class="form-group">
						<label for="inputPrereq">Prérequis</label>
						<select multiple class="form-control chosen-select" id="inputPrereq" name="inputPrereq">
				...
				<div class="form-group">
					<label for="inputPriceLMT">Prix LMT</label>
					<input type="number" class="form-control" id="inputPriceLMT" name="inputPriceLMT"/>
				</div>
				<div class="form-group">
					<label for="inputDifficulty">Difficulty</label>
					<div id="stars" class="starrr"></div>
					<input type="hidden" class="form-control" id="count" name="inputDifficulty"/>
				</div>
				<div class="form-group">
